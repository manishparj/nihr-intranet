                ...
                <Row gutter={[24, 24]}>
                  ...
                  <Col xs={24} lg={8}>
                    <Space orientation="vertical" className="w-full" size="middle">
                      ...
                      <Card size="small" title={<span className="font-bold text-xs text-slate-700 dark:text-zinc-200">📞 Urgent Desk</span>} className="rounded-xl border-slate-200 bg-amber-50/50 dark:bg-amber-950/10">
                        <div className="text-xs space-y-1 text-slate-600 dark:text-zinc-400">
                          <p className="font-bold text-[#005EB8] mt-1.5">📞 IT Hotline: 9979271578 Manish Prajapati (Ext. 704)</p>
                          <p className="font-bold text-[#005EB8]">📞 Maintenance: 94604 66977 Dr. Anil Purohit</p>
                        </div>
                      </Card>
                    </Space>
                  </Col>
                      ...
                      <Col xs={24} sm={8}>
                        <Card size="small" className="rounded-xl border border-slate-100">
                          <Statistic 
                            ...
                            styles={{ content: { color: '#005EB8', fontWeight: 800 } }} 
                          />
                        </Card>
                      </Col>
                      <Col xs={24} sm={8}>
                        <Card size="small" className="rounded-xl border border-slate-100">
                          <Statistic 
                            ...
                            styles={{ content: { color: '#cf1322', fontWeight: 800 } }} 
                          />
                        </Card>
                      </Col>
                      <Col xs={24} sm={8}>
                        <Card size="small" className="rounded-xl border border-slate-100">
                          <Statistic 
                            ...
                            styles={{ content: { color: '#3f8600', fontWeight: 800 } }} 
                          />
                        </Card>
                      </Col>
                    </Row>
