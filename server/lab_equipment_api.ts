...
router.get('/equipments', (req: Request, res: Response) => {
  ...
  const publicEquipments = equipments.map(eq => {
    ...
    return {
      ...
      make: eq.make,
      model: eq.model,
      contactPersonName: eq.contactPersonName || '',
      contactPersonEmail: eq.contactPersonEmail || '',
      contactPersonMobile: eq.contactPersonMobile || '',
...
router.put('/admin/equipments/:id', requireLabSuperUser, (req: Request, res: Response) => {
  ...
  const updated: Equipment = {
    ...
    contactPersonEmail: body.contactPersonEmail !== undefined ? body.contactPersonEmail.trim() : existing.contactPersonEmail,
    contactPersonMobile: body.contactPersonMobile !== undefined ? body.contactPersonMobile.trim() : existing.contactPersonMobile,
